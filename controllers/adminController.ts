...
export const deleteGarage = async (req: Request, res: Response): Promise<void> => {
...
export const getAppRelease = async (req: Request, res: Response): Promise<void> => {
...
export const updateAppRelease = async (req: Request, res: Response): Promise<void> => {
