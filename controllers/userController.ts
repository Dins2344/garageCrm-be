...
export const getUsers = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    log.error('Failed to fetch staff list', { garageId: req.garageId, error: (error as Error).message });
    next(error);
  }
};
...
export const createUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    log.error('Failed to create staff member', { garageId: req.garageId, error: (error as Error).message });
    next(error);
  }
};
